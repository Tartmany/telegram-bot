LEXICON_RU: dict[str, str] = {
    ...
    '/help': 'Это уже не очень простая игра. Мы одновременно должны '
             'сделать выбор одного из пяти предметов. Камень, '
             'ножницы, бумага ящерица или спок.\n\nЕсли наш выбор '
             'совпадает - ничья, а в остальных случаях камень '
             'побеждает ножницы и ящерицу, ножницы побеждают бумагу '
             'и ящерицу, бумага побеждает камень и спока, ящерица '
             'побеждает спока и бумагу, а спок побеждает камень и '
             'ножницы.\n\n<b>Играем?</b>',
    'rock': 'Камень 🗿',
    'paper': 'Бумага 📜',
    'scissors': 'Ножницы ✂',
